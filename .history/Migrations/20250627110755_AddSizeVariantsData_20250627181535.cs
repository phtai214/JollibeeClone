    ...
    public partial class AddSizeVariantsData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    VALUES 
                        ...
                        (@PepsiProductId, N'Lớn (+6.000đ)', N'Size', 6000.00, 0, 1, 1),
                        (@PepsiProductId, N'Lớn (+11.000đ)', N'Size', 11000.00, 0, 1, 2),
                        (@PepsiProductId, N'Lớn (+15.000đ)', N'Size', 15000.00, 0, 1, 3),
                        (@PepsiProductId, N'Lớn (+20.000đ)', N'Size', 20000.00, 0, 1, 4),
                        (@PepsiProductId, N'Lớn (+25.000đ)', N'Size', 25000.00, 0, 1, 5),
                        (@PepsiProductId, N'Lớn (+30.000đ)', N'Size', 30000.00, 0, 1, 6);
                END
            ");
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    UPDATE ProductConfigurationOptions 
                    SET VariantID = NULL 
                    WHERE VariantID IN (SELECT VariantID FROM ProductVariants WHERE ProductID = @ProductId);
                    ...
                    VALUES 
                        ...
                        (@ProductId, N'Lớn (+8.000đ)', N'Size', 8000.00, 0, 1, 1),
                        (@ProductId, N'Lớn (+12.000đ)', N'Size', 12000.00, 0, 1, 2),
                        (@ProductId, N'Lớn (+18.000đ)', N'Size', 18000.00, 0, 1, 3);
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    UPDATE ProductConfigurationOptions 
                    SET VariantID = NULL 
                    WHERE VariantID IN (SELECT VariantID FROM ProductVariants WHERE ProductID = @FriesId);
                    ...
                    VALUES 
                        ...
                        (@FriesId, N'Lớn (+10.000đ)', N'Size', 10000.00, 0, 1, 1),
                        (@FriesId, N'Lớn (+15.000đ)', N'Size', 15000.00, 0, 1, 2),
                        (@FriesId, N'Lớn (+22.000đ)', N'Size', 22000.00, 0, 1, 3);
                END
            ");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                AND VariantName IN (
                    N'Vừa', N'Lớn (+6.000đ)', N'Lớn (+8.000đ)', N'Lớn (+10.000đ)', N'Lớn (+11.000đ)', 
                    N'Lớn (+12.000đ)', N'Lớn (+15.000đ)', N'Lớn (+18.000đ)', N'Lớn (+20.000đ)', 
                    N'Lớn (+22.000đ)', N'Lớn (+25.000đ)', N'Lớn (+30.000đ)'
                );
            ");
        }
    }

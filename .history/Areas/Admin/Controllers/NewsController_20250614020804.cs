    ...
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, string newsType, bool? isPublished, string sortOrder, int? page)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi táº£i danh sÃ¡ch tin tá»©c.";
        ...
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null)
            {
                TempData["ErrorMessage"] = "ID tin tá»©c khÃ´ng há»£p lá»‡.";
            ...
            try
            {
                ...
                if (news == null)
                {
                    TempData["ErrorMessage"] = "KhÃ´ng tÃ¬m tháº¥y tin tá»©c.";
                    return RedirectToAction(nameof(Index));
                }
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi táº£i thÃ´ng tin tin tá»©c.";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi táº£i trang táº¡o tin tá»©c.";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,ShortDescription,Content,NewsType,AuthorID,IsPublished")] News news, IFormFile? ImageFile)
        {
            try
            {
                ...
                // Custom validation - Ä‘Æ¡n giáº£n hÃ³a Ä‘á»ƒ debug
                if (!string.IsNullOrEmpty(news.Title) && await _context.News.AnyAsync(n => n.Title.ToLower() == news.Title.ToLower()))
                {
                    ModelState.AddModelError("Title", "TiÃªu Ä‘á» tin tá»©c Ä‘Ã£ tá»“n táº¡i.");
                }
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        news.Title = "Tin tá»©c má»›i";
                    }
                    
                    if (string.IsNullOrWhiteSpace(news.Content))
                    {
                        news.Content = "Ná»™i dung tin tá»©c";
                    }
                    ...
                    TempData["SuccessMessage"] = "Tin tá»©c Ä‘Ã£ Ä‘Æ°á»£c táº¡o thÃ nh cÃ´ng!";
                    return RedirectToAction(nameof(Index));
                }
            }
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = $"CÃ³ lá»—i xáº£y ra khi táº¡o tin tá»©c: {ex.Message}";
                
                if (ex.InnerException != null)
                {
                    TempData["ErrorMessage"] += $" Chi tiáº¿t: {ex.InnerException.Message}";
                }
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("NewsID,Title,ShortDescription,Content,ImageUrl,NewsType,AuthorID,IsPublished,PublishedDate")] News news, IFormFile? ImageFile)
        {
            if (id != news.NewsID)
            {
                TempData["ErrorMessage"] = "ID tin tá»©c khÃ´ng khá»›p.";
                return RedirectToAction(nameof(Index));
            }
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        TempData["ErrorMessage"] = "KhÃ´ng tÃ¬m tháº¥y tin tá»©c Ä‘á»ƒ cáº­p nháº­t.";
                        return RedirectToAction(nameof(Index));
                    }
                    ...
                    TempData["SuccessMessage"] = "Tin tá»©c Ä‘Ã£ Ä‘Æ°á»£c cáº­p nháº­t thÃ nh cÃ´ng!";
                    return RedirectToAction(nameof(Index));
                }
            }
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    TempData["ErrorMessage"] = "Tin tá»©c Ä‘Ã£ bá»‹ thay Ä‘á»•i bá»Ÿi ngÆ°á»i dÃ¹ng khÃ¡c. Vui lÃ²ng thá»­ láº¡i.";
                }   
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error updating news: {NewsId}", id);
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi cáº­p nháº­t tin tá»©c.";
            }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi táº£i trang xÃ³a tin tá»©c.";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (news != null)
                {
                    ...
                    TempData["SuccessMessage"] = "Tin tá»©c Ä‘Ã£ Ä‘Æ°á»£c xÃ³a thÃ nh cÃ´ng!";
                }
                else
                {
                    TempData["ErrorMessage"] = "KhÃ´ng tÃ¬m tháº¥y tin tá»©c Ä‘á»ƒ xÃ³a.";
                }
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error deleting news: {NewsId}", id);
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi xÃ³a tin tá»©c.";
            }
        ...
        private async Task LoadViewBagDataAsync()
        {
            try
            {
                ...
                // Always include "-- KhÃ´ng chá»n tÃ¡c giáº£ --" option
                var authorList = new List<object>();
                authorList.Add(new { UserID = (int?)null, FullName = "-- KhÃ´ng chá»n tÃ¡c giáº£ --" });
            ...
            catch (Exception ex)
            {
                ...
                {
                    new { UserID = (int?)null, FullName = "-- KhÃ´ng chá»n tÃ¡c giáº£ --" }
                }, "UserID", "FullName");
                ViewBag.NewsTypes = new SelectList(new[]
                {
                    new { Value = "News", Text = "Tin tá»©c" },
        ...
        private string ValidateImageFile(IFormFile file)
        {
            ...
            if (!allowedExtensions.Contains(extension))
                return "Chá»‰ cháº¥p nháº­n file áº£nh vá»›i Ä‘á»‹nh dáº¡ng: JPG, JPEG, PNG, GIF, WEBP.";

            // Check content type
            var allowedContentTypes = new[] { "image/jpeg", "image/png", "image/gif", "image/webp" };
            if (!allowedContentTypes.Contains(file.ContentType.ToLowerInvariant()))
                return "Äá»‹nh dáº¡ng file khÃ´ng há»£p lá»‡.";

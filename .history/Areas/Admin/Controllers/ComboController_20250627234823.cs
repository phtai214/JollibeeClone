    ...
    public class ComboController : Controller
    {
        ...
        public async Task<IActionResult> Create(ComboCreateViewModel viewModel)
        {
            ...
            if (Request.HasFormContentType && Request.Form != null)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"=== FORM ANALYSIS ===");
                ...
                System.Diagnostics.Debug.WriteLine($"Current MaxModelBindingCollectionSize: 8192");
                
                if (totalFields > 6000)
                {
                    System.Diagnostics.Debug.WriteLine($"⚠️  WARNING: High field count detected! May exceed limits.");
                }

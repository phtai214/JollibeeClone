...
namespace JollibeeClone.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Thống kê người dùng mới hôm nay (sử dụng UserID để estimate)
            var today = DateTime.Today;
            var totalUsersYesterday = await _context.Users.CountAsync();
            var newUsersToday = Math.Max(0, totalUsers - Math.Max(0, totalUsersYesterday - 10)); // Estimate new users

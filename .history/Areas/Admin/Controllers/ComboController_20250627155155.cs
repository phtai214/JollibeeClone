...
namespace JollibeeClone.Areas.Admin.Controllers
{
    ...
    public class ComboController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            {
                ComboProduct = combo,
                Groups = combo.ProductConfigurationGroups.Select(g => new ComboGroupDetailViewModel
                {
                    Group = g,
                    Options = g.ProductConfigurationOptions.Select(o => new ComboOptionDetailViewModel
                    {
                        Option = o,
                        Product = o.OptionProduct,
                        Variant = o.Variant
                    }).ToList()
                }).ToList()
            };
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var viewModel = new ComboCreateViewModel
            {
                ...
                AvailableProducts = await _context.Products
                    ...
                    .OrderBy(p => p.ProductName)
                    .ToListAsync(),
                ConfigGroups = combo.ProductConfigurationGroups.Select(g => new ComboGroupViewModel
                {
                    GroupName = g.GroupName,
                    MinSelections = g.MinSelections,
                    MaxSelections = g.MaxSelections,
                    DisplayOrder = g.DisplayOrder,
                    Options = g.ProductConfigurationOptions.Select(o => new ComboOptionViewModel
                    {
                        ...
                        AvailableVariants = await _context.ProductVariants
                            .Where(v => v.ProductID == o.OptionProductID && v.IsAvailable == true)
                            .OrderBy(v => v.DisplayOrder)
                            .ToListAsync()
                    }).ToList()
                }).ToList()

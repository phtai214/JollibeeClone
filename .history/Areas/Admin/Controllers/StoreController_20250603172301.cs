    ...
    public class StoreController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber, string view = "grid")
        {
            try
            {
                ...
                switch (sortOrder)
                {
                    ...
                    case "date":
                        ...
                        break;
                    case "date_desc":
                        stores = stores.OrderByDescending(s => s.StoreID);
                        break;
                    default:
                ...
                int pageSize = 10;
                var paginatedStores = await PaginatedList<Store>.CreateAsync(stores.AsNoTracking(), pageNumber ?? 1, pageSize);
            ...
            catch (Exception ex)
            {
                ...
                return View(new PaginatedList<Store>(new List<Store>(), 0, 1, 10));
            }
        }

...
namespace JollibeeClone.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        // GET: Admin/Product
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber, string view = "grid", int? categoryFilter)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return View(new PaginatedList<Product>(new List<Product>(), 0, 1, 10));
            }
        }

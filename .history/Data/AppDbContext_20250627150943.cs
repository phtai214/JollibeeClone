    ...
    public class AppDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductVariant>(entity =>
            {
                ...
                entity.Property(e => e.VariantID).UseIdentityColumn(1, 1);
                entity.Property(e => e.VariantName).HasMaxLength(100).IsRequired();
            ...
            modelBuilder.Entity<ProductConfigurationOption>(entity =>
            {
                ...
                entity.HasCheckConstraint("CK_ProductConfigurationOption_Quantity", "Quantity > 0");
                ...
                entity.HasOne(e => e.Variant)
                    .WithMany(v => v.ProductConfigurationOptions)
            ...
            modelBuilder.Entity<PromotionProductScope>(entity =>
            {
                ...
                entity.ToTable("PromotionProductScopes");
            ...
            modelBuilder.Entity<PromotionCategoryScope>(entity =>
            {
                ...
                entity.ToTable("PromotionCategoryScopes");
            ...
            // Configure UserPromotion entity (User-Promotion relationship tracking)
            modelBuilder.Entity<UserPromotion>(entity =>
            {
                entity.HasKey(e => e.UserPromotionID);
                entity.Property(e => e.UserPromotionID).UseIdentityColumn(1, 1);
                ...
                // Create composite unique index to prevent duplicate usage
            ...
            modelBuilder.Entity<News>(entity =>
            {
                ...
                entity.Property(e => e.NewsID).UseIdentityColumn(1, 1);
            ...
            modelBuilder.Entity<Service>(entity =>
            {
                ...
                entity.Property(e => e.ServiceID).UseIdentityColumn(1, 1);

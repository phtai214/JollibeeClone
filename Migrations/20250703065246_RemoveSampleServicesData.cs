...
{
    /// <inheritdoc />
    public partial class RemoveSampleServicesData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                WHERE ServiceName IN (
                    N'Đặt tiệc sinh nhật',
                    N'Jollibee Kid Club', 
                    N'Đặt hàng qua hotline'
                );
            ");
        }
        ...
        {
            // Khôi phục dữ liệu mẫu khi rollback (nếu cần)
                ...
                {
                    {
                        ...
                        "/assets/images/BannerJollibeeSinhNhat_dichvu.png",
                        1,
                        true
                    },
                    {
                        ...
                        "/assets/images/BannerJollibeeKidClub_dichvu.png",
                        2,
                        true
                    },
                    {
                        ...
                        "/assets/images/bannerhotline_dichvu.png",
                        3,
                        true
                    }
                });

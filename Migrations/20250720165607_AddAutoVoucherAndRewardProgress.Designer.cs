...
namespace JollibeeClone.Migrations
{
    ...
    [Migration("20250720165607_AddAutoVoucherAndRewardProgress")]
    partial class AddAutoVoucherAndRewardProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JollibeeClone.Models.Promotion", b =>
                {
                    ...
                    b.Property<bool>("AutoVoucherGenerated")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("RewardThreshold")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("JollibeeClone.Models.UserRewardProgress", b =>
                {
                    b.Property<int>("UserRewardProgressID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserRewardProgressID"));
                    ...
                    b.Property<int?>("GeneratedPromotionID")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("VoucherClaimed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<DateTime?>("VoucherClaimedDate")
                        .HasColumnType("datetime2");

                    b.HasKey("UserRewardProgressID");

                    b.HasIndex("GeneratedPromotionID");

                    b.HasIndex("UserID", "RewardThreshold")
                        .IsUnique();

                    b.ToTable("UserRewardProgresses");
                });
            ...
            modelBuilder.Entity("JollibeeClone.Models.UserRewardProgress", b =>
                {
                    b.HasOne("JollibeeClone.Models.Promotion", "GeneratedPromotion")
                        .WithMany()
                        .HasForeignKey("GeneratedPromotionID")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("JollibeeClone.Models.User", "User")
                        .WithMany("UserRewardProgresses")
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeneratedPromotion");
            ...
            modelBuilder.Entity("JollibeeClone.Models.User", b =>
                {
                    ...
                    b.Navigation("UserRewardProgresses");

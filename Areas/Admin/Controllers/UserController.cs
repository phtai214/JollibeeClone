    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("UserID,FullName,Email,PhoneNumber,IsActive")] User user, string? newPassword)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    TempData["SuccessMessage"] = "Cáº­p nháº­t ngÆ°á»i dÃ¹ng thÃ nh cÃ´ng!";
                    return RedirectToAction(nameof(Index));
                }
            }
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    TempData["ErrorMessage"] = "NgÆ°á»i dÃ¹ng khÃ´ng tá»“n táº¡i.";
                    return RedirectToAction(nameof(Index));
                }
                else
                {
                    TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi cáº­p nháº­t. Vui lÃ²ng thá»­ láº¡i.";
                }
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error updating user ID: {UserId}", id);
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi cáº­p nháº­t ngÆ°á»i dÃ¹ng.";
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi xÃ³a ngÆ°á»i dÃ¹ng.";
            }

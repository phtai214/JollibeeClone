    ...
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ServiceID,ServiceName,ShortDescription,Content,ImageUrl,DisplayOrder,IsActive")] Service service, IFormFile? ImageFile)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi cáº­p nháº­t dá»‹ch vá»¥.";
            }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi táº£i trang xÃ³a dá»‹ch vá»¥.";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (service != null)
                {
                    ...
                    TempData["SuccessMessage"] = "Dá»‹ch vá»¥ Ä‘Ã£ Ä‘Æ°á»£c xÃ³a thÃ nh cÃ´ng!";
                }
                else
                {
                    TempData["ErrorMessage"] = "KhÃ´ng tÃ¬m tháº¥y dá»‹ch vá»¥ Ä‘á»ƒ xÃ³a.";
                }
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error deleting service: {ServiceId}", id);
                TempData["ErrorMessage"] = "CÃ³ lá»—i xáº£y ra khi xÃ³a dá»‹ch vá»¥.";
            }
